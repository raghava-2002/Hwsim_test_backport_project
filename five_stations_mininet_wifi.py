...
def topology(args):
    ...
    sta2 = net.addStation('sta2', ip='192.168.42.5/24', position='70,60,2', passwd='123456789a', encrypt='wpa3', range=35)  # 10 meters east, 2 meters up
    sta3 = net.addStation('sta3', ip='192.168.42.7/24', position='78,60,3', passwd='123456789a', encrypt='wpa3', range=35)  # 18 meters east, 3 meters up
    sta4 = net.addStation('sta4', ip='192.168.42.9/24', position='85,60,4', passwd='123456789a', encrypt='wpa3', range=35)  # 25 meters east, 4 meters up
    # Adjusted position for sta10 at 35 meters to target an RSSI of -89 dBm
    sta5 = net.addStation('sta5', ip='192.168.42.12/24', position='95,60,5.5', passwd='123456789a', encrypt='wpa3', range=35)  # 35 meters east, 5.5 meters up
