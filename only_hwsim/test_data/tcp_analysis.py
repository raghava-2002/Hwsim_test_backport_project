...
def analyze_scheme(scheme_name, directory, description):
    ...
    output_filename = f'analysis/tcp/{scheme_name}_analysis.txt'
    with open(output_filename, 'w') as f:
        ...
        f.write(f"Combined Retransmission Percentage: {combined_retransmission_percentage:.4f}%\n")
        f.write(f"Average Bandwidth: {average_bandwidth_mbps:.4f} Mbps\n")
