...
def topology(args):
    ...
    plt.savefig('/home/rathan/Downloads/hwsim_test/testing/multiple_tests/mininet_wifi_topology.png', bbox_inches='tight')  # Save the figure to a file
...
def dump_node_info(net):
    ...
    output_file = "/home/rathan/Downloads/hwsim_test/testing/multiple_tests/nodes.txt"
